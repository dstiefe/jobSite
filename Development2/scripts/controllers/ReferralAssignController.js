 ...
 */
angular.module('Jobsite').controller("ReferralAssignController", function($scope, Login, $http, $timeout, $location,$filter, ScreeningsService, JobsService, $state, $stateParams) {
